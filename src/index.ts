...
(async () => {
    ...
    const spellPart = new SpellPart(new PatternGlyph(), [new SpellPart(new PatternGlyph(), [new SpellPart(new PatternGlyph(), [])]), new SpellPart(new PatternGlyph(), []), new SpellPart(new PatternGlyph(), [])]);
